...
fig = px.scatter_3d(
    ...
    title='TransE Entity Embeddings (3D t-SNE)',
...
# 5. 그래프 출력 및 HTML 저장
fig.show()
fig.write_html(os.path.join(OUTPUT, 'transe_3d_visualization.html'))
print(f"3D 시각화 완료: {OUTPUT}/transe_3d_visualization.html")
